        ...
        if (empty(trim($_POST['alamat']))) {
            ...
            if (empty(trim($_POST['salary']))) {
                ...
                if (empty($validate_err)) {
                 Header(
                     'Location:../app/Route.php?action=tambahdata&nama='.$nama.'&alamat='.$alamat.'&salary='.$salary
                    );
                }
            }
        }
...
?>
                            <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $nama ?>" name="nama" class="form-control"
                                        id="exampleInputEmail1" placeholder="Masukan Nama">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Alamat</label>
                                    <input value="<?php echo $alamat ?>" name="alamat" class="form-control" id="exampleInputEmail1"
                                        placeholder="Masukan Alamat">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Salary</label>
                                    <input value="<?php echo $salary ?>" name="salary" class="form-control" id="exampleInputEmail1"
